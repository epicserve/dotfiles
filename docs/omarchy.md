...
4. Install the [macOS For All](https://plugins.jetbrains.com/plugin/13968-macos-for-all) keymap plugin.
5. To make it so the PyCharm debugger works with a remote Docker Compose Python interptor, allow all Docker subnet
